...
var lists = (0, _jquery2['default'])('.lists');
var form = (0, _jquery2['default'])('.myForm');
var song;
...
form.on('submit', function (event) {
  event.preventDefault();
  var search = (0, _jquery2['default'])('#search').val();
  _jquery2['default'].getJSON(url + 'tracks?client_id=' + token + '&q=' + search).then(function (res) {
    console.log('res', res);
...
function play(song, token) {
  ...
  (0, _jquery2['default'])('audio').attr('src', song + '?client_id=' + token);
}
